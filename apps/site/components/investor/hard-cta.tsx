...
const TIERS: Tier[] = [
  {
    ...
    body: "For leads and co-leads ready to discuss ticket, terms, and timing. Founder session within five business days.",
    cta: "Request allocation →",
    variant: "primary",
  },
  {
    intent: "founder-call",
    kicker: "02 · Warm walk-through",
    headline: "Book a founder call.",
    body: "Thirty minutes with the founder. Walk the system, the model, the moat. No deck theater — working session.",
    cta: "Book a founder call →",
    variant: "secondary",
  },
  {
    intent: "waitlist",
    kicker: "03 · Strategic waitlist",
    headline: "Join the strategic waitlist.",
    body: "For operators, clinicians, and advisors. Early access to the product cohort and to the thinking behind it.",

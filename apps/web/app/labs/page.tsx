            ...
            <form onSubmit={handleAdd} className="flex flex-col gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full bg-surface-2 border border-line rounded-lg px-3 py-2 text-ink text-sm focus:outline-none focus:ring-2 focus:ring-signal"
                >
                ...
                return (
                  ...
                  >
                    ...
                    {slopeLabel && dir === "worsening" && (
                      <p className="text-xs text-danger mt-1 ml-0">
                        {slopeLabel} over last 30 days
                      </p>
                    )}
                    {slopeLabel && dir === "improving" && (
                      <p className="text-xs text-ok mt-1 ml-0">
                        {slopeLabel} over last 30 days
                      </p>
                    )}

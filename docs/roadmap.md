...
**Date:** 2026-04-21
**Status:** Canonical. Supersedes the prior 3-phase stub.
...
Recommended sequencing: run both in parallel — one lane on C→S for revenue, one lane on I for moat.
...
- **HIPAA posture.** Today is "HIPAA+wellness" — meaning we act HIPAA-compliant but don't claim the regulated category until BAAs + audit are in place. S-17..S-22 is the path from posture to defensible.
